...
| 2026-09-24 | The `rejected_pipeline` status annotated with its current name | Renamed by ADR-0046 and by the operator on 2026-09-24. Annotated by the implementing seat under ADR-RULES, which allows a stale or wrong fact to be annotated unasked; the Decision Outcome is untouched. Found by the corpus audit of 2026-09-23 |
