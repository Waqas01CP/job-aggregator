...
We will write rows sourced from aggregators to local files only. They are never committed and never pushed. *(Changed by ADR-0047 on 2026-09-19, which this record did not name until 2026-09-25: aggregator rows are committed and pushed to a private repository, and still never to this one. Built 2026-09-24. The corpus audit's conflict 6.)*
...
| 2026-09-25 | ADR-0047 named at the clause it changed | ADR-0047 moves aggregator rows to a private repository, which this clause's "never committed and never pushed" contradicted with no pointer. The corpus audit of 2026-09-23 raised it as conflict 6. The later record's decision stands; this names it. Annotated by the implementing seat under ADR-RULES, on Brief 7's corpus work; the Decision Outcome is untouched. |
