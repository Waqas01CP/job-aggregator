...
**Relays** between the other three seats, and pushes the architecture chat's
commits; the implementing seat pushes its own (D10, 2026-09-25). He is not a
relay for a question either chat could answer from the repository itself.
